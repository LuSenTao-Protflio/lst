...
const projects = [
  {
    ...
    gallery: [
      ...
      { src: portfolioAsset("7.jpg"), alt: "WHELK 项目页 2", wide: false },
      { src: portfolioAsset("9.jpg"), alt: "WHELK 项目页 3", wide: false },
    ],
    ...
    <div className="site-shell">
      <header className="topbar">
        <a className="brand" href="#top" aria-label="返回顶部">
          <span className="brand-cn">作品集</span>
        ...
        <section className="about" id="info">
          ...
          >
            ...
            <div className="about-text">
              ...
              <h2>卢森涛</h2>
              <p className="about-en">Luoison · Visual Communication Design</p>
