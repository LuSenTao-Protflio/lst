    ...
    projects: {
      whelk: {
        ...
        detail: {
          ...
          ], back: "返回全部项目", nextLabel: "下一个项目", nextId: "woof", nextTitle: "WOOF-WOOF 宠物友好社交APP",
        },
      },
      woof: {
      ...
      memory: {
        ...
        detail: {
          ...
          ], back: "返回全部项目", nextLabel: "下一个项目", nextId: "metakeys", nextTitle: "MetaKeys — 模块化键帽品牌设计",
        },
      },
      metakeys: {
        title: "MetaKeys — 模块化键帽品牌设计",
        en: "MetaKeys — Modular Keycap Brand Design",
        desc: "围绕「键帽不止于按键」的品牌主张，构建模块化客制键帽的产品概念与视觉系统。以黑透键帽壳、可替换内容物和标准化底座形成产品逻辑，并延展至主海报、包装、挂绳、3D产品场景与传播物料。",
        detail: {
          meta: [
    ...
    projects: {
      whelk: {
        ...
        detail: {
          ...
          ], back: "Back to all projects", nextLabel: "Next project", nextId: "woof", nextTitle: "WOOF-WOOF — Pet-Friendly Social App",
        },
      },
      woof: {
      ...
      memory: {
        ...
        detail: {
          ...
          ], back: "Back to all projects", nextLabel: "Next project", nextId: "metakeys", nextTitle: "MetaKeys — Modular Keycap Brand Design",
        },
      },
      metakeys: {
        title: "MetaKeys — Modular Keycap Brand Design",
        en: "MetaKeys — Modular Keycap Brand Design",
        desc: "A modular custom-keycap identity built around the idea that a keycap is more than a key. A translucent shell, replaceable inner object, and standardized base create the product logic, extended across posters, packaging, lanyards, 3D product scenes, and campaign applications.",
        detail: {
          meta: [
            { label: "Project type", value: "Brand Identity · Product Visual · 3D Visual" },
            { label: "Role", value: "Brand Concept · Visual Identity · Packaging & Applications · 3D Presentation" },
            { label: "Year", value: "2025" },
          ],
          sections: [
            { label: "Brand concept", title: "A keycap as a portable, replaceable carrier of identity", body: "MetaKeys expands the custom keycap beyond a computer accessory into a medium for personal expression. Transparency, modularity, and collectability guide a consistent identity across posters, packaging, and portable applications." },
            { label: "Modular product logic", title: "A standardised base for replaceable inner objects", body: "A translucent black shell, replaceable inner object, and unified base form the modular system. Product and structural visuals emphasise assembly so the relationship between each part is immediately understandable." },
            { label: "Visual applications", title: "Extending the identity across packaging, lanyards, and 3D scenes", body: "A high-contrast black-and-white foundation combines transparent materials, green accents, and enlarged product details to establish a technical character across different media." },
          ],
          back: "Back to all projects",
          nextLabel: "Next project",
          nextTitle: "FRIDAY Origin & Passion — Fanshu Annual Gala",
        },
      },
      gala: {
